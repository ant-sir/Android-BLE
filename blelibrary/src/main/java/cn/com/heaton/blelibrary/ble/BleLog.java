...
public class BleLog {
    ...
    public static void e(Object o, String msg){
        if(isDebug){
            Log.e(TAG, buildMessage(getSubTag(o), msg));
        }
    }

    public static void i(Object o, String msg){
        if(isDebug){
            Log.i(TAG, buildMessage(getSubTag(o), msg));
        }
    }

    public static void w(Object o, String msg){
        if(isDebug){
            Log.w(TAG, buildMessage(getSubTag(o), msg));
        }
    }

    public static void d(Object o, String msg){
        if(isDebug){
            Log.d(TAG, buildMessage(getSubTag(o), msg));
        }
    }
